...
void BinarySearch(vector<int> arr, int l, int r, int n, int num)
{
      int mid = (l + r) / 2;
            if (arr[mid] == num)
            {
            ...
            {
                  BinarySearch(arr, l, mid - 1, n, num);
            }
            else if (arr[mid] < num)
            {
                  BinarySearch(arr, mid+1, r, n, num); 
            } else {
